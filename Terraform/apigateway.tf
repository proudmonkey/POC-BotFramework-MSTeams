...
resource "aws_api_gateway_integration" "integration" {
  ...
  type                    = "AWS_PROXY"
  uri                     = "arn:aws:apigateway:${var.aws_region}:lambda:path/2015-03-31/functions/arn:aws:lambda:${var.aws_region}:${var.aws_account_id}:function:${var.lambda_func_name}/invocations"
}
...
resource "aws_lambda_permission" "apigw_lambda" {
  ...
  function_name = "arn:aws:lambda:${var.aws_region}:${var.aws_account_id}:function:${var.lambda_func_name}"
